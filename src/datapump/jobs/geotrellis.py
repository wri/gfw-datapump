...
WORKER_INSTANCE_TYPES = ["r5a.2xlarge", "r5.2xlarge", "r4.2xlarge"]
...
class GeotrellisJob(Job):
            ...
            if (
                ...
                for table in self.result_tables:
                    ...
                    for version in versions_to_delete:
                        if version != "v202512" and version != "v202601":
                            client.delete_version(table.dataset, version)
    ...
    def _get_indices_and_cluster(
        ...
        if Version(self.geotrellis_version) < Version("2.1.4"):
    ...
    def _get_step(self) -> Dict[str, Any]:
        ...
        if Version(self.geotrellis_version) < Version("1.5.0"):
    ...
    def _configurations(self, worker_count: int) -> List[Dict[str, Any]]:
        ...
        if Version(self.geotrellis_version) >= Version("2.0.0"):
